...
import apps.competition.fields
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('variance_report', models.FileField(blank=True, default='', upload_to=apps.competition.fields.UploadPath('variance_report'))),
                ('csa_report', models.FileField(blank=True, default='', upload_to=apps.competition.fields.UploadPath('csa_report'))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('psa_report', models.FileField(blank=True, default='', upload_to=apps.competition.fields.UploadPath('psa_report'))),
                ...
                ('email', apps.competition.fields.LowerEmailField(blank=True, help_text='\n            The contact email of the resource.', max_length=254, null=True)),
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to=apps.competition.fields.UploadPath('image'))),
                ('bhs_id', models.IntegerField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('appearance', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='songs', to='competition.Appearance')),
            ],
            options={
                'get_latest_by': ['num'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('panelist', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='scores', to='competition.Panelist')),
                ('song', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='scores', to='competition.Song')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('oss_report', models.FileField(blank=True, default='', upload_to=apps.competition.fields.UploadPath('oss_report'))),
                ('sa_report', models.FileField(blank=True, default='', upload_to=apps.competition.fields.UploadPath('sa_report'))),
                ('legacy_oss', models.FileField(blank=True, default='', upload_to=apps.competition.fields.UploadPath('legacy_oss'))),
                ...
                ('image', models.ImageField(blank=True, max_length=255, null=True, upload_to=apps.competition.fields.UploadPath('image'))),
        ...
        migrations.AddField(
            model_name='panelist',
            name='round',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='panelists', to='competition.Round'),
        ),
        migrations.CreateModel(
            name='Outcome',
            fields=[
                ...
                ('round', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='outcomes', to='competition.Round')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            name='outcomes',
            field=models.ManyToManyField(blank=True, related_name='appearances', to='competition.Outcome'),
        ),
        migrations.AddField(
            model_name='appearance',
            name='owners',
        ...
        migrations.AddField(
            model_name='appearance',
            name='round',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='appearances', to='competition.Round'),
        ),
    ]
